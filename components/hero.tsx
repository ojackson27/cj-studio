  ...
  return (
    <section ref={ref} className="relative min-h-[100dvh] flex items-center overflow-hidden">
      <motion.div
        ...
        className="relative max-w-6xl mx-auto px-6 w-full pt-24 pb-16"
      >
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 items-center">
          ...
          <div className="max-w-3xl">
            ...
            <motion.h1
              ...
              className="text-[clamp(3.8rem,10vw,7.5rem)] font-bold tracking-[-0.03em] leading-[0.95] text-gray-900 mb-8"
            >
              Websites<br />
              built to<br />
          ...
          >
            <div className="relative w-[380px] h-[380px]">
              ...
              <div className="absolute inset-12 rounded-full bg-gradient-to-tr from-blue-200/30 via-emerald-200/30 to-pink-200/30 blur-2xl aurora-animate" />

              {/* Prism SVG */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div>
                  <svg width="200" height="220" viewBox="0 0 180 210" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-xl">
                    <defs>
                      <linearGradient id="prismHero" x1="0" y1="0" x2="180" y2="155" gradientUnits="userSpaceOnUse">
                    ...
                    <polygon points="90,10 170,155 10,155" fill="url(#prismHero)" filter="url(#glow)" />
                  ...
                  <p className="text-center text-[11px] font-semibold tracking-[0.2em] text-gray-300 mt-1 uppercase">
                    CJ Studio
                  </p>
                </div>
              </div>
